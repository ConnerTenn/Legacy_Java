...
public class VectorBotOld1 extends AdvancedRobot
{
	//build
	...
	public static final int MIN_ROBOT_DISTANCE = 20;
		...
		while (true)
		{
			...
			//turret
			{
				if (this.track)
				{
					...
					{
						setFireBullet(this.target.distance/500.0 * getEnergy());
						print("Fire:" + (this.target.distance/500.0 * getEnergy()) + "\n");
					}
				}
			}
