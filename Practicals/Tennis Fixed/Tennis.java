...
public class Tennis
{
	...
	public static void display(Player[] playerArray)
	{
	...
	{
		scanner = new Scanner(new FileReader("Tennis/tennisData3.txt"));
		//scanner = new Scanner(new FileReader("SrcPractical/Practical1/tennisData2.txt"));
		//scanner = new Scanner(System.in);
		//printer = new PrintWriter(new PrintWriter("Tennis/Out.txt"));
